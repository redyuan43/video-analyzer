...
class VideoAnalyzerUITests(unittest.TestCase):
    ...
    def test_static_ui_marks_running_and_pending_states_visually(self):
        ...
        self.assertIn('preload="none"', js)
        self.assertIn("data-src", js)
        self.assertIn("ensurePreviewVideoSource", js)
        self.assertIn("preview-source-link", js)
        ...
        self.assertIn(".preview-source-link", css)
