...
def run_multidoc_analysis(
    ...
    for packet in chapter_packets:
        ...
        response = client.generate(
            ...
            num_predict=chapter_output_budget(packet),
        )
    ...
    if is_valid_overview(overview_cached):
        ...
        overview_response = client.generate(
            prompt=build_cross_chapter_overview_prompt(chapter_results, language),
            model=model,
            temperature=temperature,
            num_predict=overview_output_budget(chapter_results),
        )
